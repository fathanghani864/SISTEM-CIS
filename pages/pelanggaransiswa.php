...
<div class="container-fluid py-4">
    <li class="nav-item d-flex align-items-center">
        <a class="btn btn-outline-primary btn-sm mb-3 me-3" target="_blank" href="http://localhost/sekolah/tambah_siswa.php">+ tambah siswa</a>
    </li>
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2 text-center">nama pelanggaran</th>
                            ...
                            <?php
                            $no = 1;
                            $sql = "SELECT * FROM tbl_kategori order by nama_pelangaran desc";
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                          ...
                                          <td class="align-middle text-center">
                                          <a type="button" href="pelaggaransiswa.php?id_kategori=<?= $data['id_kategori'] ?>"class="btn bg-gradient-success">Edit</a>
