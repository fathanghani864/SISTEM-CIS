...
<div class="container-fluid py-4">
   <li class="nav-item d-flex align-items-center">
        <a type="button" href="tambah_siswa.php?id_kategori=<?= $data['id_kategori'] ?> "class="btn btn-outline-primary btn-sm mb-3 me-3" target="_blank">Tambah siswa</a>
    </li>
        ...
        <div class="card-body px-0 pt-0 pb-2">
          <div class="table-responsive p-0">
            <table class="table align-items-center mb-0">
              ...
              $no = 1;
              //sql
              $sql = "select * from tbl_cis order by id_siswa DESC";
              ...
              ?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="align-middle text-center">
                    <a type="button" href="edit.php?id_siswa=<?= $data['id_siswa'] ?>"class="btn bg-gradient-success">Edit</></a>
